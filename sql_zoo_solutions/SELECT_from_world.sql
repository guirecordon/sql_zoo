...
SELECT name, gdp/population per_capita_gdp FROM world
WHERE population >= 200000000


--4. Show the name and population in millions for the countries of the continent 'South America'.

SELECT name, population/1000000 pop_in_mil FROM world
...
SELECT name, ROUND(gdp/population, -3) per_capita_gdp FROM world
...
SELECT name, capital
 ...
 --12. Show the name and the capital where the first letters of each match. Don't include countries where 
